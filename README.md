...
5. [AndroidManifest](#androidmanifest)
6. [Implementing the resolver service](#implementing-the-resolver-service)
7. [Match scoring](#match-scoring)
8. [Bundle contracts (V1)](#bundle-contracts-v1)
9. [AIDL interfaces](#aidl-interfaces)
10. [Threading and performance](#threading-and-performance)
11. [Error handling](#error-handling)
12. [ProGuard / R8](#proguard--r8)
13. [Testing](#testing)
14. [Play Store and security](#play-store-and-security)
15. [Windows build note](#windows-build-note)
16. [API evolution](#api-evolution)
